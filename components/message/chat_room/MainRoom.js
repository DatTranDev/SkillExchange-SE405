                ...
                if (i - 1 >= 0) {
                    ...
                    if (timeBefore) {
                        if (timeBefore.getDate() != time.getDate()) {
                            list.push(
                                <Text
                                    key={formatDateTime(messageList[i].dateTime)}
                                    style={styles.DateMessage}
                                >
                                    {formatDateTime(messageList[i].dateTime)}
                                </Text>
                            );
                        }
                    }
        ...
        <KeyboardAvoidingView style={{ flex: 1 }} behavior="padding">
            <View style={styles.Container}>
                <View style={styles.Header}>
                    ...
                    >
                        <Image
                            source={icons.back_orange}
                            style={[{ height: 25, width: 25, marginRight: 20, marginTop: 3 }]}
                        ></Image>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                        onPress={() =>
                            navigation.navigate('chatRoom/redirectInformation', {
                                id: idFriend,
                                idChat: chatId,
                            })
                        }
                ...
                {isFriend ? (
                    <View style={styles.Bottom}>
                            ...
                            <>
                                <TouchableOpacity onPress={stopRecording}>
                                    <Image
                                        ...
                                        style={{ height: 24.5, width: 22, marginRight: 8 }}
                                    />
                                </TouchableOpacity>
                        ...
                        {message.trim().length > 0 || isRecord ? (
                            <TouchableOpacity onPress={handleSendMessage}>
                                <Image
                                    source={icons.send}
                                    style={{ height: 29, width: 29, marginLeft: 7 }}
                                />
                            </TouchableOpacity>
                        ) : (
                            <>
                                <TouchableOpacity onPress={startRecording}>
                                    <Image
                                        source={icons.micro}
                                        style={{ height: 27.6, width: 27.6, marginLeft: 10 }}
                                    />
                                </TouchableOpacity>
                                ...
                                <TouchableOpacity onPress={handleChooseImage}>
                                    <Image
                                        source={icons.image}
                                        style={{ height: 22, width: 22.1, marginLeft: 10 }}
                                    />
                                </TouchableOpacity>
                                <TouchableOpacity onPress={handleChooseFile}>
                                    <Image
                                        source={icons.menu}
                                        style={{ height: 20, width: 23.5, marginLeft: 10 }}
                                    />
                                </TouchableOpacity>
                            </>
                        )}
                    ...
                    <View style={styles.UnfriendBottom}>
                        <Text>You can no longer chat with this person.</Text>
                    </View>
                )}
